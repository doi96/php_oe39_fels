<div class="col-md-3 static">
    ...
    <ul class="nav-news-feed">
        <li><i class="icon ion-ios-people-outline"></i><div><a href="newsfeed-friends.html">123 @lang('user.followings')</a></div></li>
        <li><i class="icon ion-chatboxes"></i><div><a href="newsfeed-messages.html">1000 @lang('user.word_learned')</a></div></li>
        <li><i class="icon ion-chatboxes"></i><div><a href="newsfeed-messages.html">@lang('user.profiles')</a></div></li>
